...
public class LabEventContainerTest
{
	...
	private void init() throws ParseException, TimeSetException
	{
		cont = new LabEventContainer();
	...
	@Test
	public void addLabEventToContainerTest() throws UnsupportedOperationException, ClassCastException, NullPointerException,
												IllegalArgumentException, ParseException, TimeSetException, ElementAlreadyAddedException
	{
		init();
	...
	@Test
	public void removeLabEventFromContainerTest() throws UnsupportedOperationException, ClassCastException, NullPointerException,
													IllegalArgumentException, ParseException, TimeSetException,
	...
	@Test
	public void getLabEventFromContainerTest() throws UnsupportedOperationException, ClassCastException, NullPointerException,
												IllegalArgumentException, ParseException, TimeSetException,
												ElementAlreadyAddedException, ElementNotFoundException
	{
		init();
